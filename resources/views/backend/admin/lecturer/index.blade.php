...
@section('content')
    ...
    >
        <div class="flex-row md:flex justify-between">
            <h1 class="text-4xl font-semibold text-white flex items-center mb:mb-0 mb-5">
            ...
            <form action="" class="relative">
                <input 
                    ...
                    placeholder="search" 
                    name="search" 
                    class="py-2 rounded-full px-5 mb:w-[300px] w-full bg-white text-gray-800"
                    @isset($_GET['search'])
                        value="{{ $_GET['search'] }}"
                    @endisset
                >
        ...
        <div class="flex justify-between items-center my-5">
            ...
            <div>
                ...
                >
                    ...
                    <span class="sm:inline-block hidden">Create new Lecturer Account</span>
                </a>
            </div>
        </div>
