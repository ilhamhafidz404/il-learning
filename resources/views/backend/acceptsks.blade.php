    ...
    <main class="grid grid-cols-5 gap-10">
        ...
        <section class="py-28 col-span-4 pr-20">
            ...
            <section class="p-5 mt-10 bg-white dark:bg-slate-800 shadow-md rounded text-right">
                <form action="{{ route('acceptsks.store') }}" method="POST">
                    @csrf
                    <table class="w-full text-left">
                        ...
                        @foreach ($courses as $index => $course)
                            ...
                            >
                                <td class="py-2 pl-5">
                                    <input name="select[]" type="checkbox" value="{{ $course->id }}">
                                </td>
                                <td>{{ $course->name }}</td>
                                <td>
                    ...
                    <button 
                        class="bg-indigo-500 px-5 py-3 rounded text-white mt-4 hover:bg-indigo-400"
                    >
                        Submit
                    </button>
                </form>
